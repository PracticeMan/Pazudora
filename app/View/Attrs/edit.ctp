...
<?php echo $this->Form->create('Attr'); ?>
	<fieldset>
		<legend><?php echo __('Edit Attr'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Attr.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Attr.id'))); ?></li>
