			...
			<?php foreach ($water as $water): ?>
				<tr>
					<th colspan="9" class="th_name"><div class="monster_name">
							<?php echo h($water['Monster']['name']); ?>&nbsp;</div></th>
				</tr>
				<tr>
					...
					<td class="td_hp_value"><?php echo h($water['Monster']['hp']); ?>&nbsp;</td>
					<td class="td_attack">攻撃力</td>
					<td class="td_attack_value"><?php echo h($water['Monster']['atatck']); ?>&nbsp;</td>
					<td class="td_attr">属性</td>
					<td class="td_attr_name"><?php echo h($water['Attr']['attr_type']); ?>&nbsp;</td>
					<td class="td_kind">タイプ</td>
					<td class="td_kind_name"><?php echo h($water['Kind']['kind_type']); ?>&nbsp;</td>
				</tr>
			<?php endforeach; ?>
		</table>
	</div>
